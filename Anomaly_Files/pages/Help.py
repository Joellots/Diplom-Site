...
flag_types = {
    ...
    "SH": "Соединение установлено (SYN получен, подтверждение отправлено)",
    "RSTO": "Сброс соединения пунктом назначения",
    "S1": "Соединение установлено и закрыто (получен SYN, отправлен ACK, получено сообщение RST)",
    "RSTOS0": "Сброс соединения (отправлено сообщение RST) и отсутствие ответа (открытый порт)",
    "S3": "Попытка подключения замечена и подтверждена (наполовину открыта)",
    "S2": "Соединение установлено и закрыто (SYN получен, первая отправка)",
